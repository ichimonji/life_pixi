      ...
      const
        lifeExport = () => {
          ...
          for ( z = 0; z < 4096; z = plus( z, 1 ) ) {
            ...
            z2 = z>>>4;
            if( z & 15 == 0 ) {
              instStr[z2] = dataStr[z];
            } else {
              instStr[z2] = instStr[z2] + dataStr[z];
            }
            if( z & 15 == 15 ){
              instStr[z2] = instStr[z2].replace( /0/g, 'b' ).replace( /1/g, 'o' );
              instStr[z2] = instStr[z2].replace( /(bb+|oo+)/g, ( r0, r1 ) => r1.length + r1.charAt( 0 ) );
              instStr[z2] = instStr[z2].replace( /512b/g, '' );
            }
          }
          str += instStr.join( '$' ) + '!';
